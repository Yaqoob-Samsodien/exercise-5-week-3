...
for (let init = 0; init < numbers.length; init++) { console.log(numbers[init]); }
...
for (let i = 0; i < numbers.length; i++) { if (numbers[i] % 2 === 0) { console.log(numbers[i]); } }
// TODO: Create a loop that calculates the sum of all numbers in the array
let sum = 0

for (let init = 0; init < numbers.length; init++) { sum += numbers[init]; } { console.log('Sum: ', sum); }